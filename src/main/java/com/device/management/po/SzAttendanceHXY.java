...
public class SzAttendanceHXY {
    ...
    private Integer isclassateendance;

    private Integer dyThemeid;
    ...
    public Integer getIsclassateendance() {
        return isclassateendance;
    }

    public void setIsclassateendance(Integer isclassateendance) {
        this.isclassateendance = isclassateendance;
    }

    public Integer getDyThemeid() {
        return dyThemeid;
    }

    public void setDyThemeid(Integer dyThemeid) {
        this.dyThemeid = dyThemeid;
    }
}